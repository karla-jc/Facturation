            ...
            <div class="col-7 pt-3 pb-3">
                <div class="card">
                    <div class="card-body px-5 py-5">
                        <h3 class="text-center mb-4"> <strong>Registro Inventario</strong></h4>
                        <form action="{{ route('save_inventario') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="d-grid gap-2">
                                <div class="col-md-6 offset-md-4">
                                    <button class="btn btn-success" onclick="miFunc()" type="submit" id="success">Enviar</button>
                                    <a href="{{ url('/inventario/crear')}}" class="btn btn-info">Cancelar</a>
                                </div>
                            </div>
