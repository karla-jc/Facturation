    ...
    @endif
        ...
        <div class="row justify-content-center">
         <div class="col-11 pt-6 pb-6">
                ...
                <h2 class="section-heading text-center"><strong>Lista de Inventario</strong></h2>

                <div class="col-xl-12">
                    <form action="{{route('buscar_nombre')}}"  method="get">
                        <div class="form-row">
                            ...
                            <div class="col-auto my-1">
                                ...
                                <a href="{{ url('/inventario/listar')}}" class="btn btn-success" >Todos</a>
                ...
                <a href="{{ route('inventario') }}" target="_blank" class="btn btn-info">Imprimir</a>
                <table class="table table-light">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url("/inventario/".$inventario->id_inventario.'/edit') }}" class="btn btn-warning" >   Editar</a>
                            </td>
                            <td>
                                <form action="{{ url("/inventario/".$inventario->id_inventario) }}" class="d-inline" method="post">
                                @csrf
                                {{ method_field('DELETE') }}
