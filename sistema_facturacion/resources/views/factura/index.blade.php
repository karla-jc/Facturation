    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
         <div class="col-11 pt-6 pb-6">
                ...
                <h2 class="section-heading text-center"><strong>Anular Facturas</strong></h2>

                <div class="col-xl-12">
                    <form action="{{route('buscar_factura')}}"  method="get">
                        <div class="form-row">
                            ...
                            <div class="col-auto my-1">
                                ...
                                <a href="{{ url('/factura/listar')}}" class="btn btn-success" >Todos</a>
                            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @foreach( $accounts as $account )
                                @if($factura->account_id == $account->id_account)
                                <td>{{ $account->name}}</td>
                                @endif
                            @endforeach
                            
                            @if($factura->anulado =="1")
                            <td style="background-color:#ec7373">{{ $factura->anulado ="Anulada" }}</td>
                            @elseif($factura->anulado =="0")
                            <td style="background-color:#81ec73">{{ $factura->anulado ="Activa" }}</td>
                            @endif

                            <td><a href="{{ url("/factura/".$factura->id_factura.'/edit') }}" class="btn btn-warning" id="cambio" >Cambiar</a></td>
