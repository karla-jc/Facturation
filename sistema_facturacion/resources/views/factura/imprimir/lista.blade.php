    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
         <div class="col-11 pt-6 pb-6">
                ...
                <h2 class="section-heading text-center"><strong>Lista de Facturas</strong></h2>

                <div class="col-xl-12">
                    <form action="{{route('factura_id')}}"  method="get">
                        <div class="form-row">
                            ...
                            <div class="col-auto my-1">
                                ...
                                <a href="{{ url('/factura/listarI')}}" class="btn btn-success" >Todos</a>
                            </div>
                ...
                <table class="table table-light">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{ url($factura->id_factura.'/ver') }}" class="btn btn-primary" target="_blank">Imprimir</a></td>
