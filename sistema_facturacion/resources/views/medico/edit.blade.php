            ...
            <div class="col-6 pt-5 pb-5">
                <div class="card">
                    <div class="card-body px-5 py-5">
                        <h4 class="text-center mb-4"><strong>Editar Médico</strong></h4>
                        <form action="{{ url('medico/'.$medico->id_medico) }}" method="post" enctype="multipart/form-data"> 
                            @csrf
                            @method('PATCH')
                            @include('medico.form')
                            ...
                            <div class="d-grid gap-2">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ url('/medico/listar')}}" class="btn btn-info">Regresar</a>
                                </div>
                            </div>
