            ...
            <div class="col-7 pt-3 pb-3">
                <div class="card">
                    <div class="card-body px-5 py-5">
                        <h3 class="text-center mb-4"> <strong>Registro Clientes</strong></h4>
                        <form action="{{ route('save_clientes') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="d-grid gap-3">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <a href="{{ url('/clientes/crear')}}" class="btn btn-info">Cancelar</a>
                                </div>
                            </div>
